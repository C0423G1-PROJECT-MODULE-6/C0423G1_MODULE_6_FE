                        ...
                        <div className="pt-3">
                            ...
                            >
                                ...
                                <div className="col-auto d-flex justify-content-center">
                                    <select className="form-select shadow border-dark " id="chooseSearch" onChange={handleOptionSearchChange} style={{width: "60%", marginRight: "1rem"}}>
                                ...
                                <div className="col-auto">
                                    <button className="btn btn-outline-primary text-center shadow "onClick={handleSearch}>
                                        Tìm kiếm
                                    </button>
                                </div>
                            </div>
                                ...
                                <table className=" shadow w-100">
                                    ...
                                    {productList && productList.length !== 0 ?
                                        ...
                                        <tr style={{height: '150px'}}>
                                            <td style={{fontSize: '30px', textAlign: 'center'}} colSpan="6">Không có sản phẩm nào phù hợp
                                            </td>
                                        </tr>
                                        </tbody>
                                    }
